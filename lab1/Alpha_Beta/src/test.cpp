...
int main(int argc, char* argv[]) {
    ...
    for (int i = 0; i < red_moves.size(); i++) {
        std::cout << "(" << red_moves[i].init_x << ", " << red_moves[i].init_y << ") -> ";
        std::cout << "(" << red_moves[i].next_x << ", " << red_moves[i].next_y << ") ";
        std::cout << "score " << red_moves[i].score << std::endl;
    }
    std::cout << "Black moves: " << std::endl;
    for (int i = 0; i < black_moves.size(); i++) {
        std::cout << "(" << black_moves[i].init_x << ", " << black_moves[i].init_y << ") -> ";
        std::cout << "(" << black_moves[i].next_x << ", " << black_moves[i].next_y << ") ";
